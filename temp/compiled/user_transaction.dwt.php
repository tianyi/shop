...
?>
      ...
      <?php if ($this->_var['action'] == order_detail): ?>
        ...
        <tr>
          ...
          <td align="left" bgcolor="#ffffff"><?php echo $this->_var['order']['pay_status']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_var['order']['pay_time']; ?></br><?php if ($this->_var['order']['order_amount'] > 0): ?><?php echo $this->_var['order']['pay_online']; ?><?php endif; ?></td>
        </tr>
        <tr>
