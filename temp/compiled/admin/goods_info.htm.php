...
?>
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <?php endif; ?>
          ...
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_prepay_price']; ?></td>
            <td><input type="text" name="prepay_price" value="<?php echo $this->_var['goods']['prepay_price']; ?>" size="20" onblur="priceSetted()"/>
            <?php echo $this->_var['lang']['require_field']; ?></td>
          </tr>
